				...
				<div class="col_half">
					...
					<div class="copyright-links">
						<?php if(get_theme_mod('ju_footer_tos_page')) {?>
							<a href="<?php echo get_permalink(get_theme_mod('ju_footer_tos_page')); ?>">Terms of Use</a> / 
						<?php } ?>
						<?php if(get_theme_mod('ju_footer_privacy_page')) {?>
							<a href="<?php echo get_permalink(get_theme_mod('ju_footer_privacy_page')); ?>">Privacy Policy</a> 
						<?php } ?>
					</div>
				</div>
