...
function ju_enqueue(){
    ...
    wp_register_script('ju_plugins', get_template_directory_uri().'/assets/js/plugins.js', array(), '1.0', true);
    wp_register_script('ju_functions', get_template_directory_uri().'/assets/js/functions.js', array(), '1.0', true);
